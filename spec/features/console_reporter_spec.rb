...
feature "testing with teaspoon in the console", aruba: true do
  ...
  scenario "gives me the expected results" do
    ...
    assert_partial_output("Teaspoon running default suite at http://127.0.0.1:", all_output)
    ...
    Failures:
      ...
      2) Integration tests allows erroring specs
         Failure/Error: ReferenceError: Can't find variable: foo in http://127.0.0.1:53567/assets/integration/integration_spec.js?body=1 (line 14)
    ...
    OUTPUT
    assert_partial_output(expected, all_output.gsub(/Finished in [\d\.]+ seconds/, "Finished in 0.31337 seconds"))
  end
