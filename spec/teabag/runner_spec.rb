  ...
  describe "#results" do
    ...
    describe "with no failures" do
      ...
      it "logs the details" do
        subject.results("elapsed" => 0.31337, "failures" => [], "pending" => [], "total" => 666)
    ...
    describe "with failures" do
      ...
      it "logs the details and raises an exception" do
        ...
        expect {
          subject.results("elapsed" => 0.31337, "failures" => [failures], "pending" => [], "total" => 666)
    ...
    describe "with pending" do
      ...
      it "logs the details" do
        ...
        subject.results("elapsed" => 0.31337, "failures" => [], "pending" => [pending], "total" => 666)
