...
describe Teabag::Formatter do
  ...
  describe "#initialize" do
    ...
    it "logs" do
      Teabag::Formatter.any_instance.should_receive(:log).with("Teabag starting for: foo...\n\n")
      Teabag::Formatter.new("foo")
    end
  ...
  describe "#results" do
    ...
    describe "with failures" do
      ...
      it "logs the details and raises an exception" do
        failures = {"spec" => "some spec", "description" => "some description"}
        expect {
          subject.results("elapsed" => 0.31337, "failures" => [failures], "total" => 666)
        }.to raise_error(Teabag::FailureException)
  ...
  describe "#log" do
    ...
    before do
      STDOUT.should_receive(:print).with("Teabag starting for: default...\n\n")
    end
